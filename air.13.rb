...
if tableau13 == ["1 2 3 4 \n"]
	compteur_global+=1
	compteur_succès+=1
	puts green("air.07 (#{compteur_succès}/#{compteur_global}) : success")
end
...
if tableau15 == ["error : -1\n"]
	compteur_global+=1
	puts pinkish("air.07 (#{compteur_succès}/#{compteur_global}) : error arg invalid")
end
...
if tableau16 == ["10 15 20 25 30 35\n"]
	compteur_global+=1
	compteur_succès+=1
	puts green("air.08 (#{compteur_succès}/#{compteur_global}) : success")
end
...
if tableau17 == ["\n"]
	compteur_global+=1
	puts red("air.08 (#{compteur_succès}/#{compteur_global}) : failure")
end
...
if tableau18 == ["Albert, Thérèse, Benoit, Michel\n"]
	compteur_global+=1
	compteur_succès+=1
	puts green("air.09 (#{compteur_succès}/#{compteur_global}) : success")
end
...
if tableau19 == ["error : -1\n"]
	compteur_global+=1
	puts pinkish("air.09 (#{compteur_succès}/#{compteur_global}) : error arg invalid")
end
...
if tableau20 == ["Hello les amis, comment ça va aujourd’hui?\n"]
	compteur_global+=1
	compteur_succès+=1
	puts green("air.10 (#{compteur_succès}/#{compteur_global}) : success")
end
...
if tableau22 == ["      I\n     III\n    IIIII\n   IIIIIII\n  IIIIIIIII\n IIIIIIIIIII\n"]
	compteur_global+=1
	compteur_succès+=1
	puts green("air.11 (#{compteur_succès}/#{compteur_global}) : success")
end
...
if tableau23 == ["error : -1\n"]
	compteur_global+=1
	puts pinkish("air.23 (#{compteur_succès}/#{compteur_global}) : error arg invalid")
end
...
if tableau24 == ["1  2  3  4  5 6\n"]
	compteur_global+=1
	compteur_succès+=1
	puts green("air.12 (#{compteur_succès}/#{compteur_global}) : success")
end
